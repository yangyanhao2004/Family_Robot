...
class Router:
    ...
    _T2S = str.maketrans(
        "氣麼幾嗎時聞條頭發樣關於會過來對體點號電話見說聽寫讓業東衝國絕綜變熱滿灑獲從當兩無舉處謂樂營僅嚴回廚請設計難重準單華頓舊紐約倫爾羅馬門亞歐際貝雲廣鄭陽慶蘇衛漢島連龍鐵嶺橋莊張灣興銀寧遠風鳳園環勝紀統經標縣鎮區納維邁",
        "气么几吗时闻条头发样关于会过来对体点号电话见说听写让业东冲国绝综变热满洒获从当两无举处谓乐营仅严回厨请设计难重准单华顿旧纽约伦尔罗马门亚欧际贝云广郑阳庆苏卫汉岛连龙铁岭桥庄张湾兴银宁远凤凰园环胜纪统经标县镇区纳维迈",
    )
