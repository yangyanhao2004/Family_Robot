...
class Router:
    ...
    _T2S = str.maketrans(
        "氣麼幾嗎時聞條頭發樣關於會過來對體點號電話見說聽寫讓業東衝國絕綜變熱滿灑獲從當兩無舉處謂樂營僅嚴回廚請設計難重準單華頓舊紐約倫爾羅馬門亞歐際貝雲廣鄭陽慶蘇衛漢島連龍鐵嶺橋莊張灣興銀寧遠風鳳園環勝紀統經標縣鎮區納維邁進後轉動運備門員戰邊際權",
        "气么几吗时闻条头发样关于会过来对体点号电话见说听写让业东冲国绝综变热满洒获从当两无举处谓乐营仅严回厨请设计难重准单华顿旧纽约伦尔罗马门亚欧际贝云广郑阳庆苏卫汉岛连龙铁岭桥庄张湾兴银宁远凤凰园环胜纪统经标县镇区纳维迈进后转动运备门员战边际权",
    )
    ...
    def _extract_location(self, user_input: str, response_text: str) -> str:
        ...
        cn_patterns = [
            ...
            r"(?:\u4eca\u5929|\u660e\u5929|\u6628\u5929|\u73b0\u5728)?([\u4e00-\u9fa5]{2,4}?)(?:\u7684)?(?:\u5929\u6c14|\u6c14\u6e29|\u6e29\u5ea6|\u600e\u4e48\u6837|\u5982\u4f55)",
            # "\u5929\u6c14\u5728\u5317\u4eac\u600e\u4e48\u6837"
