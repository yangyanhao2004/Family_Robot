...
import { Bell, Mail, Volume2, Pencil, Trash2, ToggleLeft, ToggleRight } from 'lucide-vue-next'
...
<template>
  <div class="flex flex-col h-full bg-[#0D0D0D]">
    ...
    <div class="flex-1 overflow-y-auto px-5 py-4">
      ...
      <!-- Empty -->
      <div v-else-if="reminders.length === 0" class="flex flex-col items-center justify-center h-48 text-neutral-600 gap-3">
